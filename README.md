...
# How to use
The application is hosted [here](http://fantasyzoning.mozhu.io). Please use it on a laptop screen, large tablet, or monitor as this application is not designed for phones.
