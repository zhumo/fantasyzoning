...
const datasets = [
  { file: 'parcels.geojson', overlayFile: 'parcels-overlay.csv', modelFile: 'parcels-model.csv', name: 'SF Parcels', color: '#066' },
];
...
async function loadDataset() {
  ...
  const [geomResponse, overlayResponse, modelResponse, bartResponse, muniResponse, caltrainResponse] = await Promise.all([
    ...
    <div class="map-wrapper">
      ...
      <div v-if="hoveredParcel" class="tooltip" :style="{ left: tooltipPosition.x + 15 + 'px', top: tooltipPosition.y + 15 + 'px' }">
        <table>
          <tbody>
            ...
            <tr v-if="hoveredParcel.Height_Ft">
              <td class="key">FZP Height</td>
              <td class="value">{{ Math.floor(hoveredParcel.Height_Ft) }} ft</td>
            </tr>
            <tr v-if="hoveredParcel.Height_Ft">
              <td class="key">Your Proposed Height</td>
              <td class="value">{{ Math.floor(hoveredParcel.effective_height || hoveredParcel.Height_Ft) }} ft</td>
            </tr>
      ...
      <div class="legend">
        ...
        <div class="legend-items">
          ...
          <div class="legend-item">
            <span class="legend-color" style="background: #081d58;"></span>
            <span>115-125</span>
          </div>
          <div class="legend-item">
          ...
          <div class="legend-item">
            <span class="legend-color" style="background: #7a0177;"></span>
            <span>135-145</span>
          </div>
          <div class="legend-item">
            <span class="legend-color" style="background: #ae017e;"></span>
            <span>145-150</span>
          </div>
          <div class="legend-item">
            <span class="legend-color" style="background: #dd3497;"></span>
            <span>150+</span>
          </div>
        </div>
      </div>
